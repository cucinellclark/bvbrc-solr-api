...
export { createClient, index as default, getAllAntibiotics, getAllGenomeFeatures, getAllGenomes, getAntibiotic, getAntibioticByAtcClassification, getAntibioticByCasId, getAntibioticByMechanismOfAction, getAntibioticByMolecularFormula, getAntibioticByName, getAntibioticByPharmacologicalClass, getAntibioticBySynonym, getGenome, getGenomeByAltitude, getGenomeByAssemblyAccession, getGenomeByAssemblyMethod, getGenomeByBioprojectAccession, getGenomeByBiosampleAccession, getGenomeByBiovar, getGenomeByCdsCountRange, getGenomeByCellShape, getGenomeByClade, getGenomeByClass, getGenomeByCollectionYearRange, getGenomeByContigCountRange, getGenomeByDateRange, getGenomeByDepth, getGenomeByFamily, getGenomeByGcContentRange, getGenomeByGenbankAccessions, getGenomeByGenomeLengthRange, getGenomeByGenomeName, getGenomeByGenomeQuality, getGenomeByGenomeStatus, getGenomeByGenus, getGenomeByGeographicGroup, getGenomeByGeographicLocation, getGenomeByGramStain, getGenomeByHabitat, getGenomeByIsolationCountry, getGenomeByIsolationSource, getGenomeByKingdom, getGenomeByLineage, getGenomeByMlst, getGenomeByMotility, getGenomeByOptimalTemperature, getGenomeByOrder, getGenomeByOrganismName, getGenomeByOxygenRequirement, getGenomeByPathovar, getGenomeByPhylum, getGenomeByPublicStatus, getGenomeByRefseqAccessions, getGenomeBySalinity, getGenomeBySequencingPlatform, getGenomeBySerovar, getGenomeBySpecies, getGenomeBySporulation, getGenomeBySraAccession, getGenomeByStrain, getGenomeBySubclade, getGenomeBySubtype, getGenomeBySuperkingdom, getGenomeByTaxonId, getGenomeByTemperatureRange, getGenomeByTypeStrain, getGenomeFeature, getGenomeFeatureByAccession, getGenomeFeatureByAnnotation, getGenomeFeatureByFeatureType, getGenomeFeatureByGene, getGenomeFeatureByGenomeId, getGenomeFeatureByGenomeName, getGenomeFeatureByGoTerm, getGenomeFeatureByLocationRange, getGenomeFeatureByPatricId, getGenomeFeatureByProduct, getGenomeFeatureByProteinId, getGenomeFeatureByProteinLengthRange, getGenomeFeatureByPublicStatus, getGenomeFeatureBySequenceLengthRange, getGenomeFeatureByStrand, getGenomeFeatureByUniprotAccession, query, queryAntibioticsBy, queryGenomeBy, queryGenomeFeatureBy, searchAntibioticsByKeyword };
